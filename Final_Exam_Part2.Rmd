...
```{r chunk-a, message=FALSE,warning = FALSE}
library(tm) 
library(tidyverse)
library(slam)
library(proxy)
...
```{r chunk-b, message=FALSE,warning = FALSE, ref.label= 'chunk-a'}
### Next Author
...
```{r chunk-c, message=FALSE, warning = FALSE, ref.label= c('chunk-a,chunk-b')}
...
```{r chunk-d, message=FALSE, warning = FALSE, ref.label= c('chunk-a,chunk-b','chunk-c')}
### Next Author
...
```{r chunk-e, message=FALSE, warning = FALSE, ref.label= c('chunk-a',chunk-b','chunk-c','chunk-d')}
